      ...
      nav: [
        ...
        { text: '学习路线', link: '/10-roadmap/learning-path' },
        {
          ...
          items: [
            ...
            { text: '分布式系统基础', link: '/01-foundation/distributed-systems/' },
          ],
        },
        {
          text: '云原生',
          items: [
            ...
            { text: 'GPU 在 Kubernetes 上的调度 总览', link: '/02-cloud-native/gpu-scheduling/' },
          ],
        },
        {
          text: 'LLMOps',
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Airflow 总览', link: '/03-ai-platform/airflow/' },
            { text: 'Airflow 1. 背景', link: '/03-ai-platform/airflow/01-background' },
            { text: 'Airflow 2. 核心思想', link: '/03-ai-platform/airflow/02-core-ideas' },
            { text: 'Airflow 3. 架构设计', link: '/03-ai-platform/airflow/03-architecture' },
            { text: 'Airflow 4. 调度工作流程', link: '/03-ai-platform/airflow/04-scheduling-workflow' },
            { text: 'Airflow 5. 核心模块', link: '/03-ai-platform/airflow/05-core-modules' },
            { text: 'Airflow 6. 源码分析', link: '/03-ai-platform/airflow/06-source-analysis' },
            { text: 'Airflow 7. Mini Demo', link: '/03-ai-platform/airflow/07-mini-demo' },
            { text: 'Airflow 8. 企业生产实践', link: '/03-ai-platform/airflow/08-production-practice' },
            { text: 'Airflow 9. 最佳实践', link: '/03-ai-platform/airflow/09-best-practices' },
            { text: 'Airflow 10. 面试题', link: '/03-ai-platform/airflow/10-interview-questions' },
            { text: 'Airflow 11. 延伸阅读', link: '/03-ai-platform/airflow/11-further-reading' },
          ],
        },
        {
          text: 'Agent',
